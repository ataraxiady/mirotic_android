...
public class SendMsgTask extends AsyncTask<String, Integer, SendResult>{
    ...
    @Override
    protected SendResult doInBackground(String... strings) {
        ...
        try {
            ...
            result = gson.fromJson(str, SendResult.class);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @Override
    protected void onPostExecute(SendResult sendResult) {
